...
LABEL maintainer="Farmexa Platform" \
    ...
    traefik.http.routers.farmexa-wildcard-http.rule="HostRegexp(`[a-zA-Z0-9-]+\\.arosoftlabs\\.com`) && !Host(`farm.arosoftlabs.com`) && !Host(`www.arosoftlabs.com`) && !Host(`app.arosoftlabs.com`) && !Host(`cp.arosoftlabs.com`) && !Host(`mail.arosoftlabs.com`) && !Host(`courses.arosoftlabs.com`) && !Host(`demo.arosoftlabs.com`) && !Host(`my.arosoftlabs.com`) && !Host(`arofi.arosoftlabs.com`) && !Host(`api.arosoftlabs.com`) && !Host(`admin.arosoftlabs.com`) && !Host(`support.arosoftlabs.com`) && !Host(`myfarm.arosoftlabs.com`)" \
    ...
    traefik.http.routers.farmexa-wildcard.rule="HostRegexp(`[a-zA-Z0-9-]+\\.arosoftlabs\\.com`) && !Host(`farm.arosoftlabs.com`) && !Host(`www.arosoftlabs.com`) && !Host(`app.arosoftlabs.com`) && !Host(`cp.arosoftlabs.com`) && !Host(`mail.arosoftlabs.com`) && !Host(`courses.arosoftlabs.com`) && !Host(`demo.arosoftlabs.com`) && !Host(`my.arosoftlabs.com`) && !Host(`arofi.arosoftlabs.com`) && !Host(`api.arosoftlabs.com`) && !Host(`admin.arosoftlabs.com`) && !Host(`support.arosoftlabs.com`) && !Host(`myfarm.arosoftlabs.com`)" \

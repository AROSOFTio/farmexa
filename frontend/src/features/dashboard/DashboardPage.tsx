                ...
                <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="colorRev" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#108A43" stopOpacity={0.11}/>
                      <stop offset="95%" stopColor="#108A43" stopOpacity={0}/>
                    </linearGradient>
                  ...
                  <Area type="monotone" dataKey="revenue" stroke="#108A43" strokeWidth={2} fillOpacity={1} fill="url(#colorRev)" />

...
export function LoginPage() {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen items-center justify-center bg-[var(--app-bg)] px-4 py-8 sm:px-6">
        {/* Top utility bar */}
        ...
        <motion.div
          ...
          className="grid w-full max-w-[1000px] overflow-hidden rounded-[24px] border border-[var(--border-subtle)] bg-[var(--surface-card)] shadow-[0_40px_90px_-40px_rgba(15,23,42,0.4)] lg:min-h-[600px] lg:grid-cols-2"
        >
          ...
          <div className="flex flex-col justify-center px-7 py-10 sm:px-10 lg:py-12">
            {/* Brand — mobile only (showcase carries branding on desktop) */}
            <div className="mb-7 flex justify-center lg:hidden">
              <BrandMark />
            </div>

            <div className="mb-7">
              <h1 className="text-[1.7rem] font-bold leading-tight text-[var(--text-strong)]">Welcome back</h1>
            ...
            {/* Footer links */}
            <div className="mt-7 flex items-center justify-between border-t border-[var(--border-subtle)] pt-5 text-[12px] text-[var(--text-muted)]">
